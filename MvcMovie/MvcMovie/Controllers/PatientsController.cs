...
namespace MvcMovie.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public PatientsController(s17301Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPatient,FirstName,LastName,Birthdate")] Patients patients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPatient,FirstName,LastName,Birthdate")] Patients patients)
        {
